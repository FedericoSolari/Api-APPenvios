class ParseadorSolicitudes
  ...
  def generar_cuerpo_solicitud_cliente(parametros)
    { comando: parametros[1], body: { nombre: parametros[2], direccion: parametros[3], codigo_postal: parametros[4], id_cliente: parametros[5] } }
  end

  def generar_cuerpo_solicitud_cadete(parametros)
    { comando: parametros[1], body: { nombre: parametros[2], vehiculo: parametros[3], id_cadete: parametros[4] } }
  end
end
