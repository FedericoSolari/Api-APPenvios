...
Característica: Validar domicilio en la creacion de un envio
  ...
  Escenario: Registro fallido al ingresar un domicilio inexistente/invalido
    Cuando envio el mensaje '/nuevo-envio clasico, chico, noexistedomicilio, CP: 0000'
  ...
  Escenario: Registro fallido al ingresar un domicilio con datos faltantes
    Cuando envio el mensaje '/nuevo-envio clasico, chico, Cerrito 628'
    Entonces deberia ver un mensaje "Verifique haber ingresado los datos necesarios, el formato correcto es: \<Tipo\>, \<Tamaño\>, \<Domicilio\> \<Altura\>, CP: \<codigo postal\>"
